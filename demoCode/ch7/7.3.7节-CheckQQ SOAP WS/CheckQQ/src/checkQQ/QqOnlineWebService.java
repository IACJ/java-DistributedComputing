 ...
 * 和/或其各供应商不为本页面提供信息的错误、残缺、延迟或因依靠此信息所采取的任何行动负责。</br>此腾讯QQ在线状态Web
 * Services请不要用于任何商业目的，若有需要请<a
 * href="http://www.webxml.com.cn/zh_cn/contact_us.aspx"
 * target="_blank">联系我们</a>，欢迎技术交流。 QQ：8409035<br />
 * <strong>使用本站 WEB 服务请注明或链接本站：http://www.webxml.com.cn/ 感谢大家的支持</strong>！<br />
 * <br />
 * &nbsp;
 * 
...
public class QqOnlineWebService extends Service {
	...
	private final static Logger logger = Logger
			.getLogger(checkQQ.QqOnlineWebService.class.getName());

	static {
		URL url = null;
		try {
			URL baseUrl;
			baseUrl = checkQQ.QqOnlineWebService.class.getResource(".");
			url = new URL(baseUrl,
					"http://www.webxml.com.cn/webservices/qqOnlineWebService.asmx?wsdl");
		} catch (MalformedURLException e) {
			logger.warning("Failed to create URL for the wsdl Location: 'http://www.webxml.com.cn/webservices/qqOnlineWebService.asmx?wsdl', retrying as a local file");
