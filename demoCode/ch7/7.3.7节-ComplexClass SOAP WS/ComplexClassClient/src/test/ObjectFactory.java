...
public class ObjectFactory {
	...
	private final static QName _GetPerson_QNAME = new QName("http://service/",
			"getPerson");
	private final static QName _GetPersonResponse_QNAME = new QName(
			"http://service/", "getPersonResponse");
	...
	public JAXBElement<GetPerson> createGetPerson(GetPerson value) {
		return new JAXBElement<GetPerson>(_GetPerson_QNAME, GetPerson.class,
				null, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link GetPersonResponse }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "http://service/", name = "getPersonResponse")
	public JAXBElement<GetPersonResponse> createGetPersonResponse(
			GetPersonResponse value) {
		return new JAXBElement<GetPersonResponse>(_GetPersonResponse_QNAME,
